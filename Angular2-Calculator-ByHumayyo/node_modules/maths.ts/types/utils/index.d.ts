 ...
 */
export declare function getRandomNatural(lowerBound: number, upperBound: number): number;
/**
 ...
 */
export declare function getRandomNumber(lowerBound: number, upperBound: number): number;
