...
const simulatedAnnealing_1 = require("../../metaheuristics/simulatedAnnealing");
const table_1 = require("table");
const lop_1 = require("./lop");
const fs = require("fs");
...
fs.readFile(filename, 'utf8', (err, data) => {
    ...
    const lop = lop_1.generateLOP(dataset);
    const report = [
        ...
        neighborhoodDiversity.forEach(nv => {
            neighborhoodSize.forEach(ns => {
                ...
                for (let i = 0; i < reps; i++) {
                    ...
                    let time = +new Date();
                    // Generate solution
                    const s = simulatedAnnealing_1.simulatedAnnealing(lop, ns, nv, t.t0, t.tf, t.decrease);
    ...
    console.log(table_1.table(report));
    let csvData = '';
