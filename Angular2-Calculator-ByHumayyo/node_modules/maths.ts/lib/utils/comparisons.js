 ...
 */
function isAscendingArray(a, compare = ascending) {
...
exports.isAscendingArray = isAscendingArray;
/**
 ...
 */
function isDescendingArray(a, compare = descending) {
    for (let i = 1; i < a.length; i++) {
        if (compare(a[i - 1], a[i]) > 0) {
            return false;
        }
...
exports.isDescendingArray = isDescendingArray;
/**
